...
def example_bell_state():
    ...
    plt.tight_layout()
    plt.savefig('debug_bell_state_probabilities.png', dpi=150, bbox_inches='tight')
...
def example_ghz_state():
    ...
    ax = plot_state_probabilities(psi, show_labels=True)
    plt.tight_layout()
    plt.savefig('debug_ghz_state_probabilities.png', dpi=150, bbox_inches='tight')
...
def example_mixed_state_diagonal():
    ...
    plt.tight_layout()
    plt.savefig('debug_mixed_state_diagonal.png', dpi=150, bbox_inches='tight')
...
def example_pure_state_with_coherence():
    ...
    plt.tight_layout()
    plt.savefig('debug_pure_state_magnitude.png', dpi=150, bbox_inches='tight')
    ...
    plt.tight_layout()
    plt.savefig('debug_pure_state_phase.png', dpi=150, bbox_inches='tight')
...
def example_complex_coherences():
    ...
    plt.tight_layout()
    plt.savefig('debug_complex_coherences_magnitude.png', dpi=150, bbox_inches='tight')
    ...
    plt.tight_layout()
    plt.savefig('debug_complex_coherences_phase.png', dpi=150, bbox_inches='tight')
