...
def example_basic_mwis():
    ...
    plt.tight_layout()
    plt.savefig("mwis_example_basic.png", dpi=150, bbox_inches='tight')
    plt.close()
...
def example_conflict_detection():
    ...
    plt.tight_layout()
    plt.savefig("mwis_example_conflicts.png", dpi=150, bbox_inches='tight')
    plt.close()
...
def example_solution_comparison():
    ...
    plt.savefig("mwis_example_comparison.png", dpi=150, bbox_inches='tight')
    plt.close()
...
def example_2d_grid():
    ...
    edges = []
    pos_array = np.array(reg.positions)
    for i in range(9):
    ...
    plt.tight_layout()
    plt.savefig("mwis_example_2d_grid.png", dpi=150, bbox_inches='tight')
    plt.close()
