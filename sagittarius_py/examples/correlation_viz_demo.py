...
def main():
    ...
    ax1 = plot_pair_correlation_matrix(
        ...
        save_path="correlation_pair.png"
    )
    ...
    ax2 = plot_connected_correlation_matrix(
        ...
        save_path="correlation_connected.png"
    )
    ...
    ax3 = plot_pauli_zz_matrix(
        ...
        save_path="correlation_pauli_zz.png"
    )
