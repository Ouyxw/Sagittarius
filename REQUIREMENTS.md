...
3. CI and release automation: Done for fast PR CI, clean artifact smoke, and CI documentation. Cross-platform matrix, TestPyPI, and CUDA workflows remain manual release gates until their retained evidence passes. See `docs/reference/ci-workflows.md`.
