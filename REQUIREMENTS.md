...
| **Benchmark Plotting Helpers** | Medium | Mixed | Diagnostic plotting helpers exist for runtime, memory, parity, solver, and success/failure records. They do not validate arbitrary dictionaries as `benchmark-artifact/v1`; public claims still require governed retained evidence. |
