...
def example_time_grid_diagnostics():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, "time_grid_diagnostics.png"), dpi=150, bbox_inches='tight')
    print(f"Saved: {os.path.join(OUTPUT_DIR, 'time_grid_diagnostics.png')}")
    plt.close()
...
def example_lindblad_validation():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, "lindblad_validation.png"), dpi=150, bbox_inches='tight')
    print(f"Saved: {os.path.join(OUTPUT_DIR, 'lindblad_validation.png')}")
    plt.close()
...
def example_mcwf_vs_lindblad():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, "mcwf_comparison.png"), dpi=150, bbox_inches='tight')
    print(f"Saved: {os.path.join(OUTPUT_DIR, 'mcwf_vs_lindblad.png')}")
    plt.close()
...
def example_trajectory_statistics():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, "trajectory_statistics.png"), dpi=150, bbox_inches='tight')
    print(f"Saved: {os.path.join(OUTPUT_DIR, 'trajectory_statistics.png')}")
    plt.close()
