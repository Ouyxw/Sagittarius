...
def example_1_sweep_heatmap():
    ...
    output_path = os.path.join(OUTPUT_DIR, 'example_sweep_heatmap.png')
...
def example_2_line_slice():
    ...
    output_path = os.path.join(OUTPUT_DIR, 'example_line_slice.png')
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"\n✓ Saved: {output_path}")
    print("  • Features:")
...
def example_3_final_observable_map():
    ...
    output_path = os.path.join(OUTPUT_DIR, 'example_final_observable.png')
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"\n✓ Saved: {output_path}")
    print("  • Features:")
...
def example_4_failed_run_mask():
    ...
    output_path = os.path.join(OUTPUT_DIR, 'example_failed_mask.png')
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"\n✓ Saved: {output_path}")
    print("  • Features:")
...
def example_6_complete_workflow():
    ...
    plt.tight_layout()
    output_path = os.path.join(OUTPUT_DIR, 'example_complete_workflow.png')
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
...
def example_7_observables_comparison():
    ...
    output_path = os.path.join(OUTPUT_DIR, 'example_observables_comparison.png')
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"\n✓ Saved: {output_path}")
    print("  • Features:")
    ...
    output_path = os.path.join(OUTPUT_DIR, 'example_observables_normalized.png')
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"✓ Saved: {output_path}")
