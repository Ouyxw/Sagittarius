...
plt.savefig(os.path.join(OUTPUT_DIR, 'test_count_mode.png'), dpi=150, bbox_inches='tight')
plt.close()
...
plt.savefig(os.path.join(OUTPUT_DIR, 'test_frequency_mode.png'), dpi=150, bbox_inches='tight')
plt.close()
...
plt.savefig(os.path.join(OUTPUT_DIR, 'test_seed_metadata.png'), dpi=150, bbox_inches='tight')
plt.close()
...
plt.savefig(os.path.join(OUTPUT_DIR, 'test_shots_display.png'), dpi=150, bbox_inches='tight')
plt.close()
...
plt.savefig(os.path.join(OUTPUT_DIR, 'test_sorting_order.png'), dpi=150, bbox_inches='tight')
plt.close()
...
plt.savefig(os.path.join(OUTPUT_DIR, 'test_topk.png'), dpi=150, bbox_inches='tight')
plt.close()
...
plt.savefig(os.path.join(OUTPUT_DIR, 'test_hide_seed.png'), dpi=150, bbox_inches='tight')
plt.close()
