...
A relocatable wheel that works after the source checkout is moved or deleted is planned Phase 13 work. See [Package installation status](package-installation.md).
