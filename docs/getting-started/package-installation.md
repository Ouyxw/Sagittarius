...
This is a local release-readiness gate, not PyPI publication approval. PyPI remains blocked until clean CI execution, uninstall/reinstall smoke tests, package metadata review, and the cross-platform support matrix are complete.
