...
See [Julia backend setup](backend-setup.md) for native Julia runtime notes. Python JuliaPkg-specific setup remains documented in [Python backend setup](../python/backend-setup.md).
