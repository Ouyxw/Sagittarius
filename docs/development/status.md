...
| :--- | :--- | :--- | :--- | :--- | :--- |
| - | [`getting-started/installation.md`](../getting-started/installation.md) | Installation map and current Python/Julia support boundary. | Phase 13 | Current | Source/wheel/PyPI support, Julia package setup, or language-specific install paths change. |
...
| - | [`getting-started/python/package-installation.md`](../getting-started/python/package-installation.md) | Python wheel/sdist/PyPI status, upgrade, uninstall, release artifact criteria, and Julia-native boundary. | Phase 13 | Current | Any artifact build, wheel, sdist, package data, PyPI readiness, or embedded Julia backend policy changes. |
...
| - | [`getting-started/python/experiment-recipes.md`](../getting-started/python/experiment-recipes.md) | Runnable Phase 15 Python experiment recipes with result artifacts, manifests, and interpretation boundaries. | Phase 15 | Current | Recipe scenarios, public Python API usage, artifact paths, numerical reference checks, or supported noise/readout boundaries change. |
...
| - | [`getting-started/python/wheel-experiment-recipe.md`](../getting-started/python/wheel-experiment-recipe.md) | Repository-external wheel-installed UDG/MWIS recipe and `/tmp` clean-wheel smoke contract. | Phase 15 | Current | Wheel recipe imports, external-project layout, package-resource checks, artifact contract, or smoke command changes. |
...
| - | [`getting-started/package-installation.md`](../getting-started/package-installation.md) | Compatibility entry for package installation status. | Phase 13 | Current | Redirect target changes or package status split changes. |
...
| `SPEC-API-006` | [`api/SPEC-API-006-visualization.md`](../api/SPEC-API-006-visualization.md) | Python visualization and reporting helpers, including backend-free plots, diagnostics, exports, reports, and persisted scientific sweep-artifact resolution. | Phase 19 | Current | Public visualization exports, return types, artifact/report metadata, backend-initialization boundary, benchmark-claim wording, or sweep-artifact support changes. |
| `SPEC-API-007` | [`api/SPEC-API-007-experiment-config.md`](../api/SPEC-API-007-experiment-config.md) | Validated JSON-only experiment declaration, execution, output, source-config provenance, and compatible state-preparation boundary. | Phase 15 | Current | Config schema fields, JSON pulse forms, artifact paths, provenance links, or replayability boundaries change. |
| `SPEC-API-008` | [`api/SPEC-API-008-sweep-artifact.md`](../api/SPEC-API-008-sweep-artifact.md) | Resumable scientific-exploration sweep artifact contract, separate from benchmark evidence. | Phase 15 | Current | Sweep schema, item status, failure, manifest/result links, resume policy, or evidence boundary changes. |
...
| Spec ID | Document | Purpose | Roadmap link | Status | Update when |
| :--- | :--- | :--- | :--- | :--- | :--- |
| - | [`benchmarks/README.md`](../benchmarks/README.md) | Phase 16 benchmark protocol index and evidence-level routing. | Phase 16 | Mixed implementation | Benchmark document set, evidence levels, or governance references change. |
...
| - | [`benchmarks/families.md`](../benchmarks/families.md) | Family-specific benchmark protocols for physics, dynamics, open systems, optimization, backend performance, and sweeps. | Phase 16 | Mixed implementation | Benchmark families, scenario coverage, correctness gates, or required evidence change. |
...
| Spec ID | Document | Purpose | Roadmap link | Status | Update when |
| :--- | :--- | :--- | :--- | :--- | :--- |
| - | [`development/README.md`](README.md) | Index for reusable contributor and AI-agent development workflow templates. | Cross-phase development workflow | Template | Development workflow templates, agent collaboration process, or branch customization policy changes. |
| - | [`development/agent-workflow-template.md`](agent-workflow-template.md) | Reusable AI-agent workflow template for feature, development, release, benchmark, and documentation branches. | Cross-phase development workflow | Template | Agent collaboration process, branch workflow expectations, test matrix, or handoff requirements change. |
| - | [`development/prompt-context.md`](prompt-context.md) | Bilingual prompt standards for starting, resuming, implementing, reviewing, and closing AI-assisted branch work. | Cross-phase AI-assisted development workflow | Template | Prompt templates, branch context expectations, or AI handoff requirements change. |

| - | [`requirements.md`](requirements.md) | Internal roadmap and acceptance criteria. | Cross-phase development workflow | Internal | Roadmap phase scope, acceptance criteria, or release decisions change. |
| - | [`pypi-publication.md`](pypi-publication.md) | Internal Phase 13 publication runbook and evidence policy. | Phase 13 | Internal | Candidate identity, release gates, publisher controls, or publication evidence changes. |
| - | [`containerization.md`](containerization.md) | Experimental CUDA devcontainer setup and troubleshooting. | Phase 5, Phase 13 | Internal | Devcontainer image, CUDA.jl pin, driver requirements, or GPU test policy changes. |
...
| - | [`reference/data-model.md`](../reference/data-model.md) | User objects, Julia physics objects, result sections, manifests, schemas, artifacts, and planned data-model extensions. | Phase 1, Phase 6, Phase 8, Phase 10 | Current | Public objects, manifests, artifact fields (including trajectory-data/v1), schemas, indexing semantics, or Python/Julia parity behavior changes. |
...
| `SPEC-DATA-001` | [`reference/SPEC-DATA-001-shared-result-schema.md`](../reference/SPEC-DATA-001-shared-result-schema.md) | `shared-result/v1` language-neutral result payload. | Phase 8 | Current | Shared result schema, result-artifact trajectory fields, or Julia serialization behavior changes. |
...
| `SPEC-GOV-006` | [`governance/SPEC-GOV-006-release-candidate-governance.md`](../governance/SPEC-GOV-006-release-candidate-governance.md) | Release branches, immutable candidate identity, build-once artifact promotion, PyPI/CUDA gates, package-content boundaries, and the current branch transition plan. | Phase 13 | Policy | Branch/tag model, release artifact identity, publication gates, package contents, evidence retention, or repository disclosure rules change. |
| `SPEC-GOV-007` | [`governance/SPEC-GOV-007-public-release-authorization.md`](../governance/SPEC-GOV-007-public-release-authorization.md) | Authorization record, disclosure review, and independent GitHub approval controls for making the monorepo public and promoting a verified package release. | Phase 13 | Policy | Repository visibility decision, disclosure scope, authorization roles, protected-environment controls, or public-release evidence changes. |
...
- Future packaging or release changes should update all installation pages, [`reference/SPEC-BACKEND-001-backends.md`](../reference/SPEC-BACKEND-001-backends.md), [`governance/SPEC-GOV-006-release-candidate-governance.md`](../governance/SPEC-GOV-006-release-candidate-governance.md), [`reference/known-limitations.md`](../reference/known-limitations.md), root [`README.md`](../../README.md), and any packaging release notes.
...
| `SPEC-API-007` | [`api/SPEC-API-007-experiment-config.md`](../api/SPEC-API-007-experiment-config.md) | Validated JSON-only experiment declaration, execution, output, and source-config provenance contract. | Phase 15 | Current | Config schema fields, JSON pulse forms, artifact paths, provenance links, or replayability boundaries change. |
| `SPEC-API-008` | [`api/SPEC-API-008-sweep-artifact.md`](../api/SPEC-API-008-sweep-artifact.md) | Resumable scientific-exploration sweep artifact contract, separate from benchmark evidence. | Phase 15 | Current | Sweep schema, item status, failure, manifest/result links, resume policy, or evidence boundary changes. |
...
- Repository layout or package-boundary changes should be checked against [`governance/SPEC-GOV-005-repository-versioning.md`](../governance/SPEC-GOV-005-repository-versioning.md). Candidate freeze, tag, artifact promotion, or production publication changes should be checked against [`governance/SPEC-GOV-006-release-candidate-governance.md`](../governance/SPEC-GOV-006-release-candidate-governance.md). Any public benchmark or hardware-facing claim should be checked against [`governance/SPEC-GOV-004-benchmarking-plan.md`](../governance/SPEC-GOV-004-benchmarking-plan.md), [`governance/SPEC-GOV-001-performance-claims.md`](../governance/SPEC-GOV-001-performance-claims.md), [`governance/SPEC-GOV-003-prior-art-notes.md`](../governance/SPEC-GOV-003-prior-art-notes.md), and [`governance/SPEC-GOV-002-disclosure-control.md`](../governance/SPEC-GOV-002-disclosure-control.md).
