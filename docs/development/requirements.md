...
| **Physics Baseline Benchmarks** | High | Mixed | Runnable CPU smoke cases now cover single-atom Rabi and two-atom blockade with retained result/manifest links and analytic or reduced-basis checks. Landau-Zener/adiabatic sweep and small-chain full-vs-reduced correctness tiers remain planned. |
